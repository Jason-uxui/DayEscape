      ...
      <main className="flex-grow flex items-center justify-center p-4 relative min-h-screen">
        ...
        <div className="w-full max-w-[400px] mx-auto space-y-6 bg-white p-6 rounded-lg shadow-lg relative z-20">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-2xl font-semibold text-[#130f26]">Hello, Welcome Back</h1>
            <p className="text-[#4f4f4f] text-sm">
              First time here?{" "}
              <Link href="/signup" className="text-[#0f373d] hover:underline">
                Sign up Free
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isEmailUnconfirmed && (
              <div className="mt-4 p-4 bg-yellow-100 border border-yellow-400 text-yellow-700 rounded">
                <p>Your email address is not confirmed. Please check your inbox for a confirmation email.</p>
                <Button
                  onClick={handleResendConfirmation}
                  variant="link"
                  className="mt-2 p-0 h-auto text-yellow-700 hover:text-yellow-900"
                >
          ...
          <div className="text-center">
            <Link href="/forgot-password" className="text-sm text-[#4f4f4f] hover:text-[#130f26]">
              Forgot the password?
            </Link>
          </div>
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-white px-2 text-[#4f4f4f]">or continue with</span>
              </div>
            </div>
